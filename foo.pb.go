...
func (*One) Descriptor() ([]byte, []int) { return fileDescriptorFoo, []int{0} }

func (m *One) GetI() int64 {
	if m != nil {
		return m.I
	}
	return 0
...
func init() {
	proto.RegisterType((*One)(nil), "foo.One")
}
func (m *One) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *One) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.I != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintFoo(dAtA, i, uint64(m.I))
	}
	return i, nil
}
...
func (m *One) Size() (n int) {
	var l int
	_ = l
	if m.I != 0 {
		n += 1 + sovFoo(uint64(m.I))
	}
	return n
}
...
func (m *One) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: One: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: One: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
var fileDescriptorFoo = []byte{
	...
	0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x4e, 0xcb, 0xcf, 0x57, 0x12, 0xe6, 0x62, 0xf6, 0xcf,
	0x4b, 0x15, 0xe2, 0xe1, 0x62, 0xcc, 0x94, 0x60, 0x54, 0x60, 0xd4, 0x60, 0x0e, 0x62, 0xcc, 0x74,
	0xe2, 0x39, 0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39, 0xc6, 0x07, 0x8f, 0xe4, 0x18, 0x93, 0xd8,
	0xc0, 0xca, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x84, 0xf5, 0x7b, 0xfa, 0x3b, 0x00, 0x00,
	0x00,
}
